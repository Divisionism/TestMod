package com.divisionism.TestMod.client.gui;
...
public class TestChestScreen extends ContainerScreen<TestChestContainer> {
    ...
    private final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(ExampleMod.MOD_ID, "textures/gui/test_chest.png");

    public TestChestScreen(TestChestContainer container, PlayerInventory inv, ITextComponent title) {
